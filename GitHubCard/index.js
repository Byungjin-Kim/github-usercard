...
const followersArray = [`tetondan`, `dustinmyers`, `justsml`, `luishrd`, `bigknell`, 'Byungjin-Kim'];
...
function getGitCard (username) {
  ...
  .then(resp => {
    document.querySelector('.cards').appendChild(githubUsercard(resp.data));
  })
  .catch(err => console.log(err))

}
axios.get('https://api.github.com/users/Byungjin-Kim')
...
//3-1.create fuction 
function githubUsercard (gitInfo) { 
